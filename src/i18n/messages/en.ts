...
export const en = {
  ...
  home: {
    ...
    statusOfflineTimeout: "Server did not respond in time (timeout).",
    statusOk: "OK",
    locking: "Locking…",
  ...
  vault: {
    ...
    addDoc: "+ ADD DOC",
    showEditHistory: "GET REPORT",
    editHistoryTitle: "REPORT",
    editHistoryEmptyTitle: "No report yet",
    editHistoryEmptyBody:
      "Edits and transfers will appear here as you update and move this belonging.",
    historyEvent: "Event",
    historyCreated: "Created",
    historyCreatedOn: "Created on {{date}}",
    historyCreatedBy: "Created by {{name}}",
    historyCreatedByUnknown: "Created by unknown user",
    historyUpdated: "Edited",
    historyTransfer: "Transfer",
    historyEventGrantCreated: "Invite sent",
    historyEventGrantAccepted: "Access granted",
    historyEventGrantDeclined: "Invite declined",
    historyEventGrantInviteCancelled: "Invite cancelled",
    historyGrantRevoked: "Access removed",
    historyTransferRequested: "Transfer requested",
