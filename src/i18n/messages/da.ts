...
export const da: Dictionary = {
  ...
  vault: {
    ...
    addDoc: "+ TILFØJ DOK",
    showEditHistory: "SE REDIGERINGSHISTORIK",
    editHistoryTitle: "REDIGERINGSHISTORIK",
    editHistoryEmptyTitle: "Ingen historik endnu",
    editHistoryEmptyBody:
      "Redigeringer og hændelser vil blive vist her, når du opdaterer denne ejendel.",
