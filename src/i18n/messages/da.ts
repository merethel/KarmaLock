...
export const da: Dictionary = {
  ...
  vault: {
    ...
    addDoc: "+ TILFØJ DOK",
    showEditHistory: "HENT RAPPORT",
    editHistoryTitle: "RAPPORT",
    editHistoryEmptyTitle: "Ingen rapport endnu",
    editHistoryEmptyBody:
      "Redigeringer og overførsler vil blive vist her, når du opdaterer eller overfører denne ejendel.",
    historyEvent: "Hændelse",
    historyCreated: "Oprettet",
    historyCreatedOn: "Oprettet den {{date}}",
    historyCreatedBy: "Oprettet af {{name}}",
    historyCreatedByUnknown: "Oprettet af ukendt bruger",
    historyUpdated: "Redigeret",
    historyTransfer: "Overførsel",
    historyEventGrantCreated: "Invitation sendt",
    historyEventGrantAccepted: "Adgang givet",
    historyEventGrantDeclined: "Invitation afvist",
    historyEventGrantInviteCancelled: "Invitation annulleret",
    historyGrantRevoked: "Adgang fjernet",
    historyTransferRequested: "Overførsel anmodet",
  ...
  settings: {
    ...
    transfersInbox: "Notifikationer",
    transfersInboxSubtitle: "Overførsler og opdateringer.",
  ...
  transfers: {
    ...
    acceptedToastTitle: "Overførsel accepteret",
  ...
  grants: {
    ...
    ownerInviteAcceptedTitle: "Invitation accepteret",
